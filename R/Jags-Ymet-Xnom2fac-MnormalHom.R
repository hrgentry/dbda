...
genMCMC.JagsYmetXnom2facMnormalHom = function(object,  datFrm , yName="y" , x1Name="x1" , x2Name="x2" ,
...
smryMCMC.JagsYmetXnom2facMnormalHom = function(object,   codaSamples , 
...
plotMCMC.JagsYmetXnom2facMnormalHom = function(object, codaSamples , 
                     ...
                     verbose = 0) {
  skip.x2levels <- is.null(x2levels)
