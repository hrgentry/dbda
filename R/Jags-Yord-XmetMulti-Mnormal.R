...
genMCMC.JagsYordXmetMultiMnormal = function(object, data , xName , yName , 
...
smryMCMC.JagsYordXmetMultiMnormal = function(object,  codaSamples , 
                      saveName=NULL ) {
  summaryInfo = NULL
...
plotMCMC.JagsYordXmetMultiMnormal = function(object, codaSamples , data , xName="x" , yName="y" ,
